...
// 8 Kanal Rollosteuerung // TODO: free up IO pins... not using 8 channels, yet!
// - 
...
#define HMW_DEVICETYPE 0x92 //BL8 device (make sure to import hbw_lc_bl8.xml into FHEM)
...
// TODO: change pins for Bus to UART and free oders... (BUTTON to A7, etc.)
// #define BLIND5_ACT 5
// #define BLIND5_DIR 6
// #define BLIND6_ACT 7
// #define BLIND6_DIR 8
...
hbwdebug("TimeTopBottom: "); hbwdebug(hbwconfig.blindscfg[3].blindTimeTopBottom, DEC); hbwdebug("\n");
hbwdebug("TimeBottomTop: "); hbwdebug(hbwconfig.blindscfg[3].blindTimeBottomTop, DEC); hbwdebug("\n");
hbwdebug("TimeTurnAround: "); hbwdebug(hbwconfig.blindscfg[3].blindTimeChangeOver, DEC); hbwdebug("\n");
}
