...
#define LED LED_BUILTIN        // Signal-LED
  ...
  #define shiftReg_Data  3       //DS serial data input
  #define shiftReg_Clock 6       //SH_CP shift register clock input
  #define shiftReg_Latch 5       //ST_CP storage register clock input
  #define shiftReg_OutputEnable 12   // OE output enable, connect to all shift register

  #define LINE_INDICATOR_PIN 10//A3
...
//  #define BLOCKED_TWI_SCL A5  // used by I²C - SCL
  ...
  #define shiftReg_Data  5       //DS serial data input
  #define shiftReg_Clock 6       //SH_CP shift register clock input
  #define shiftReg_Latch 7       //ST_CP storage register clock input
  #define shiftReg_OutputEnable 12   // OE output enable, connect to all shift register

  #define LINE_INDICATOR_PIN 10
